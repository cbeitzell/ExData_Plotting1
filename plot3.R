# the plot3 script will take a set of energy data residing in the energyDT
# and convert the Sub_metering_1, Sub_metering_2, and Sub_metering_3 into a line
# plot by the date and time.  It will also add a lengend of the variables.
...
plot3 <- function() {
	...
	# using the energyDT data, create a plot, and add points to it.  LAstly add
